	...
	switch (MK)
		...
		case 1: // Plot Нарисовать график (На входе тип графика)
			...
			case 0: // Обычный график
				plt::plot(X, Y, { {"color", Format[0]},              // Set line color 
			{"marker", Format[1]},               // Set marker type (circle in this case) 
			{"markersize",Format[2]} });
			case 1: //Гистограмма 
				break;
			}
		...
		case 101: // MarkSet Установить маркер
			Format[1] = Load.toStr();
			break;
		case 102: // LineWidthSet Установить толщину
			Format[2] = Load.toStr();
			break;
