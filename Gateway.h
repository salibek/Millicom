...
//	int GatewayMkRange = 0; // Диапазон МК для шлюза
	...
	long int HeaderVolum = 0; // Длина заголовка передаваемого пакета данных
	...
	long int Mode = 0; // 0 - дуплекс, 1 - симплекс от шлюза, 2 - симплекс к шлюзу, 3 - полудуплекс
	...
	// Блок статитики
	long int DataCount = 0, MkCount=0; // Объем данных и количество МК переденных через шлюз
