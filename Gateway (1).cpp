...
//		 = Load.toInt();
	...
	case 40: // StatsReset Сброс блока статистики
		...
		AverageMKQueue = 0;
		break;
	case 45: // DataCountOut Выдать объем переданных данных через канал (в обе стороны)
		Load.Write(DataCount);
		break;
	case 50: // DataCountMkOut Выдать МК с объемом переданных данных через канал (в обе стороны)
